# how do i run two nodes with this same source code???
...
class Blockchain(object):
    ...
    def new_block(self, proof, previous_hash = None):
        ...
        :param proof: <int> The proof given by the Poof-of-Work algorithm
    ...
    def new_transaction(self, sender, recipient, amount):
        ...
        """
        Creates a new transaction to go into the next mined bock
    ...
    def valid_chain(self, chain):
        ...
        while current_index < len(chain):
            ...
            # Check tha the hash of the previous block is correct
    ...
    def hash(block):
        ...
        # We much make sure that the Dictionary is ordered, or we will have inconsistent hashes
